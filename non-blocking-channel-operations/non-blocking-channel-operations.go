package nonblockchanops

import "fmt"

/*
Basic sends and receives on channels are blocking.
However, we can use select with a default clause to implement non-blocking sendsd, receives, and even non-blocking multi-way selects.
*/
...
func NonBlockingChannelOperations() {
	...
	*/
	...
	/*
		...
		Here msg cannot be sent to the messgaes channel,
